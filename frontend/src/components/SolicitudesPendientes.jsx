              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="border-b border-darkBorder bg-darkSurface">
                    <th className="py-4 px-6 text-sm font-semibold text-slate-300 w-1/3">Nombre de la compañía</th>
                      ...
                      <div className="flex flex-col gap-8">
                        ...
                        <div className="flex items-start gap-5 p-4 bg-darkBg/30 border border-darkBorder rounded-xl">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 mt-3">
                              ...
                              <span className="px-2 py-0.5 bg-slate-800 text-slate-300 text-[10px] uppercase tracking-wider font-bold rounded-md border border-slate-700">Año: {solicitud.año}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          ...
                          <div className="space-y-6">
                            <section>
                              <label className="text-[11px] text-slate-500 uppercase font-black tracking-[0.1em] mb-3 block">Información de Contacto</label>
                              <div className="space-y-3 bg-darkBg/20 p-4 rounded-lg border border-darkBorder/50">
                                <div>
                                  <p className="text-slate-500 text-[11px] mb-0.5">Correo Electrónico</p>
                                  <p className="text-slate-100 text-sm">{solicitud.correo}</p>
                                </div>
                                <div>
                                  <p className="text-slate-500 text-[11px] mb-0.5">Ubicación (Región)</p>
                            ...
                            <section>
                              <label className="text-[11px] text-slate-500 uppercase font-black tracking-[0.1em] mb-3 block">Métricas Clave</label>
                              <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-6">
                            <section>
                              <label className="text-[11px] text-slate-500 uppercase font-black tracking-[0.1em] mb-3 block">Descripción del Proyecto</label>
                            ...
                            <section>
                              <label className="text-[11px] text-slate-500 uppercase font-black tracking-[0.1em] mb-3 block">Pitch & Clasificación</label>
