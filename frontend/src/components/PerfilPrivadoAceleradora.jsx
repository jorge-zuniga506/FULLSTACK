            ...
            <main className="flex-1 overflow-y-auto">
                <header className="top-0 z-10 backdrop-blur-md border-b border-slate-200 px-8 py-6 bg-darkSurface/50 border-darkBorder">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            <h2 className="text-2xl font-bold">Edición de Perfil</h2>
                            <p className="text-slate-500 dark:text-slate-400 text-sm">Gestiona la información y los detalles técnicos de tu programa de aceleración.</p>
                        </div>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 shadow-sm bg-darkSurface border-darkBorder">
                            ...
                            <div className="md:col-span-2 flex flex-col gap-2">
                                <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Descripción del Programa</label>
                    ...
                    <section>
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button className="flex items-center gap-2 text-sm font-semibold hover:underline text-primary" data-bs-toggle="modal" data-bs-target={`#exampleModal`}>
                                <span className="material-symbols-outlined text-sm">add</span>Añadir Mentor
                            </button>
                        </div>
                            ...
                            <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            <button className='btn btn-success' onClick={añadirMentor} data-bs-dismiss="modal">Añadir</button>
                                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
