    ...
    <div className="bg-background text-primary/80 font-body selection:bg-primary/30 antialiased min-h-screen">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-[#242b3d] border-r border-white/5 flex flex-col py-8 px-4 hidden lg:flex z-40 font-['Inter'] text-sm shadow-2xl">
        ...
        <div className="mt-auto px-4 py-4 rounded-2xl glass-card">
          <p className="text-xs text-on-surface-variant leading-relaxed">¿Quieres acelerar tu startup? Aplica a nuestro próximo batch.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-4 space-y-6">
              <div className="p-8 rounded-2xl bg-slate-900/60 border border-white/5 h-full">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-headline text-lg font-bold uppercase tracking-tight text-on-surface-variant">Sectores de Interés</h3>
                </div>
            ...
            <div className="md:col-span-12 space-y-6">
              <div className="flex justify-between items-end mb-4">
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm mt-1">Expertos de la industria a tu disposición.</p>
                </div>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {(aceleradora.mentores || [
                   { nombre: "Elena García", cargo: "Ex-VP of Growth @ Stripe", desc: "Experta en escalabilidad." },
                   { nombre: "Marc Schmidt", cargo: "CTO @ UnicornAI", desc: "Especialista en ML Operations." },
                   { nombre: "Sara Méndez", cargo: "Partner @ Capital Ventures", desc: "Asesoría en fundraising." },
                   { nombre: "David López", cargo: "Founder @ SaaSFlow", desc: "Estrategias de Go-To-Market." }
                ]).map((m, idx) => (
            ...
            <div className="md:col-span-12 flex flex-col md:flex-row justify-between items-center gap-6 p-10 bg-surface-container-lowest rounded-3xl border border-outline-variant/5">
              <div className="text-center md:text-left">
                ...
                <p className="text-on-surface-variant text-sm">Nuestro programa de aceleración abre convocatorias 2 veces al año.</p>
              </div>
              <div className="flex gap-4">
