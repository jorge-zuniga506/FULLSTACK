    ...
    <div style={{ backgroundColor: "#060e20", color: "#dee5ff" }}>
      ...
      <section className="text-center" style={{ paddingTop: "100px"}}>
        <Container>
          ...
          <h1 className="display-3 fw-bold">Nuestra Misi³n</h1>
          <p className="lead">
            Actualmente hay falta de gu­a en lo respecta a la inversi³n y la bºsqueda de empresas en las cuales invertir.
        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6}>
              ...
              <p>
                StartupHub naci³ de una observaci³n cr­tica en el ecosistema emprendedor: el abismo existente entre las ideas disruptivas y el capital necesario para escalarlas.
              </p>
              <p>
                Fundada por veteranos de la industria financiera y tecnol³gica, nuestra plataforma se disen³ para democratizar el acceso al financiamiento institucional.
              </p>
              <p>
      ...
      <section className="py-5 bg-dark">
        <Container>
          ...
          <Row>
            {["Transparencia", "Innovaci³n", "Impacto"].map((item, i) => (
      ...
      <section className="py-5">
        <Container>
          <div className="mb-5">
            ...
            <p>Mentes brillantes unidas por un ºnico objetivo.</p>
          </div>

          <Row>
            {["Alejandro Rivas", "Sofia Chen", "Lucas Meyer", "Isabel Garc­a"].map((name, i) => (
