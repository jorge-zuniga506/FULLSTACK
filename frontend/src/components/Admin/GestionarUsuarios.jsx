...
function GestionarUsuarios() {
  ...
  async function eliminarUsuario(tipo, id) {
    if (!window.confirm("¿Est¡s seguro de que deseas eliminar este usuario?")) return;
              ...
              <table className="w-full text-left border-collapse min-w-[800px]">
                <thead>
                  <tr className="border-b border-darkBorder bg-darkSurface">
                    ...
                    <th className="py-4 px-6 text-sm font-semibold text-slate-300">Correo Electr³nico</th>
