...
function DashboardAdmin() {
  ...
  async function cargarDatosIniciales() {
    // Obtener solicitudes (lo que ya ten­as)
      ...
      <main className="flex-1 flex flex-col overflow-y-auto bg-slate-950/20">
        ...
        <div className="p-8 space-y-8">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card-premium p-6 rounded-theme flex items-center justify-between group" data-purpose="kpi-card">
              <div>
                ...
                <p className="text-emerald-400 text-xs mt-2 font-semibold flex items-center gap-1">
                  <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full glow-accent"></span> â†‘ 12% vs mes ant.
                </p>
              </div>
            ...
            <div className="card-premium p-6 rounded-theme flex items-center justify-between group" data-purpose="kpi-card">
              <div>
                ...
                <p className="text-emerald-400 text-xs mt-2 font-semibold">â†‘ 5% vs mes ant.</p>
              </div>
            ...
            <div className="card-premium p-6 rounded-theme flex items-center justify-between group" data-purpose="kpi-card">
              <div>
                ...
                <p className="text-emerald-400 text-xs mt-2 font-semibold">â†‘ 18% vs mes ant.</p>
              </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 card-premium p-6 rounded-theme">
              <div className="flex items-center justify-between mb-6">
                ...
                <select className="bg-slate-800 border border-white/5 text-xs rounded-theme py-1 px-3 focus:ring-1 focus:ring-[#00d4ff] text-slate-300">
                  <option>šltimos 6 meses</option>
                  <option>šltimo ano</option>
                </select>
              </div>
            ...
            <div className="card-premium p-6 rounded-theme">
              <h2 className="text-lg font-display font-semibold mb-6 text-white">Distribuci³n de Capital</h2>
          ...
          <section className="card-premium rounded-theme overflow-hidden">
            <div className="p-6 border-b border-white/5 flex items-center justify-between">
              <h2 className="text-lg font-display font-semibold text-white">Startups Recientes para Aprobaci³n</h2>
        ...
        <footer className="mt-auto p-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-slate-500 text-sm gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a className="hover:text-[#00d4ff] transition-colors" href="#">T©rminos</a>
            ...
            <div className="modal-content bg-slate-900 border border-white/10 text-slate-100">
              ...
              <div className="modal-body overflow-y-auto max-h-[70vh]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
                  <div>
                    <label className="text-xs text-slate-500 uppercase font-bold tracking-wider">Informaci³n de la Compan­a</label>
                    <div className="mt-2 space-y-3">
                      ...
                      <div><span className="text-slate-400 text-sm">Descripci³n:</span> <p className="text-slate-100 text-sm">{solicitud.descripcion}</p></div>
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-slate-500 uppercase font-bold tracking-wider">M©tricas y Ronda</label>
                    <div className="mt-2 space-y-3">
                      ...
                      <div><span className="text-slate-400 text-sm">Meta de Recaudaci³n:</span> <p className="text-slate-100 font-mono">${solicitud.raise}</p></div>
                    </div>
                  </div>
