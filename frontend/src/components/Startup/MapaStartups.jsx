...
// Importaci³n de assets (asegºrate de que las rutas sean correctas)
        ...
        <div className="map-layout-wrapper">
            <header className="main-header">
                <div className="flex items-center gap-2">
                    ...
                    </span> <span><Link to="/">Inicio</Link></span> <span><Link to="/PerfilPrivadoInversor">Perfil</Link></span>
                </div>

                <div className="relative">
                    <input
                        className="search-input"
                        placeholder='Buscar por nombre, sector o tecnolog­a...'
                        type="text"
                        value={buscador}
            ...
            <div className="content-body">
                <aside className="filters-sidebar">
                    ...
                    <FilterGroup title={`Ano de Fundaci³n: ${ano}`}>
                        <input
                            type="range"
                            min={2010}
                            max={2025}
                ...
                <main className="map-container-view">
                    ...
                    >
                        ...
                        {(startups || [])
                            ...
                            .filter(s => !ano || s.ano?.toString() === ano.toString())
                            .map((s, i) => {
                                        ...
                                        <Popup>
                                            <div className="p-1">
                                                ...
                                                <div className="mt-2 pt-2 border-t border-slate-700 flex justify-between">
                                                    <span className="text-[9px] uppercase font-bold text-slate-500">Fundada: {s.ano}</span>
                                                    <span className="text-[9px] uppercase font-bold text-blue-500"><button onClick={verMas}>Ver m¡s</button></span>
                                                </div>
                                            </div>
                                        </Popup>
                                    </Marker>
...
// Componente Helper para los filtros
