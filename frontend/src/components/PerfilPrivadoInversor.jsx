...
function PerfilPrivadoInversor() {
    ...
    const [contraseñaInversor, setContraseñaInversor] = useState("")
    ...
    useEffect(() => {
        async function obtenerInversores() {
            ...
            setContraseñaInversor(filtro[0].contraseña)
    ...
    async function añadirInversion() {
        const startup = {
                ...
                <div className="max-w-4xl mx-auto w-full p-8 space-y-12">
                    ...
                    <section>
                        <div className="flex items-center gap-6 mb-8">
                            ...
                            <div>
                                <h2 className="text-2xl font-black tracking-tight">Información Personal</h2>
                                <p className="text-slate-500 dark:text-slate-400">Actualiza tus datos de contacto y biografía pública.</p>
                            </div>
                        </div>
                    ...
                    <section className="space-y-6">
                        <div>
                            <h2 className="text-2xl font-black tracking-tight">Tesis de Inversión</h2>
                            <p className="text-slate-500 dark:text-slate-400">Describe qué buscas en las startups y cuál es tu valor añadido.</p>
                        </div>
                        <div className="space-y-2">
                            <textarea className="w-full bg-slate-800 border-none text-sm rounded-xl px-4 py-3 focus:ring-1 focus:ring-primary outline-none transition-all text-white" placeholder="Escribe tu tesis aquí..." rows="4" value={tesisInversor} onChange={(e) => setTesisInversor(e.target.value)} />
                        </div>
                    </section>
                    {/* Interested Sectors */}
                    <section className="space-y-6">
                        <div>
                            <h2 className="text-2xl font-black tracking-tight">Sectores de Interés</h2>
                                ...
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            ...
                                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={añadirSector}>Añadir</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-2xl font-black tracking-tight">Gestión de Portafolio</h2>
                            ...
                            <div className="modal fade" id={`exampleModal2`} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={añadirInversion}>Añadir</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-darkSurface border border-darkBorder rounded-xl hover:border-primary/30 transition-all group">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-slate-500">{startup.sector} • {startup.rondaActual}</p>
                                </div>
