...
function PerfilPrivadoStartup() {
    ...
    const [contraseñaStartup, setContraseñaStartup] = useState("")
    ...
    useEffect(() => {
        async function obtenerStartups() {
            ...
            if (filtro.length > 0) {
                ...
                setContraseñaStartup(filtro[0].contraseña)
                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <section className="bg-darkSurface rounded-[8px] border border-darkBorder p-6">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-400 mb-1 block">Short Pitch (una oración)</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-400 mb-1 block">Descripción Completa</label>
                    ...
                    <section className="bg-darkSurface rounded-[8px] border border-darkBorder p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button className="text-sm font-bold text-primary flex items-center gap-1 hover:underline" data-bs-toggle="modal" data-bs-target={`#exampleModal`}>
                                <span className="material-symbols-outlined text-sm">add</span> Añadir Miembro
                            </button>
                        </div>
                                ...
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-footer">
                                            ...
                                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={añadirMiembro}>Añadir</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
