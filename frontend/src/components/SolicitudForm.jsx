...
function SolicitudForm() {
    ...
    function enviarSolicitud() {
        const objSolicitud = {
            ...
            año, correo, contraseña, logotipo, arr, usuarios, crecimiento,
            sector, etapa, modelo, raise, pitch, descripcion, rol
        };

        if (!nombre || listaMiembros.length === 0 || !url || region === "0" || !latitud || !longitud || !correo || !contraseña || !logotipo || !arr || !usuarios || !crecimiento || sector === "0" || etapa === "0" || modelo === "0" || !raise || !pitch || !descripcion) {
            alert("Por favor, coloca todos los datos y asegúrate de agregar al menos un miembro.");
            return;
        }
            ...
            <main className="flex flex-1 justify-center py-10 px-4">
                <div className="max-w-[800px] flex-1 flex flex-col gap-8">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-slate-400 text-base">Conecta tu startup con los mejores inversores de la región.</p>
                    </div>
                    ...
                    <section className="bg-darkSurface/30 p-6 rounded-xl border border-darkBorder">
                        <div className="flex items-center gap-2 mb-6 border-b border-darkBorder pb-2">
                            ...
                            <h2 className="text-slate-100 text-xl font-bold">Información Básica</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <label>
                                <p className="text-slate-300 text-sm mb-2 font-medium">Correo Electrónico</p>
                             ...
                             <label>
                                 <p className="text-slate-300 text-sm mb-2 font-medium">Contraseña</p>
                                 <input className="form-input-custom" type="password" value={contraseña} onChange={(e) => setContraseña(e.target.value)} placeholder="••••••••" shade="dark" />
                        ...
                        <div className="mt-8 p-4 bg-slate-800/50 rounded-lg border border-darkBorder">
                            ...
                            <div className="flex flex-wrap gap-4 mb-4">
                                ...
                                <input className="form-input-custom !h-11" placeholder="Función (CEO, CTO...)" value={funcionMiembro} onChange={(e) => setFuncionMiembro(e.target.value)} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <label>
                                <p className="text-slate-300 text-sm mb-2 font-medium">Región</p>
                            ...
                            <label>
                                <p className="text-slate-300 text-sm mb-2 font-medium">Año de Fundación: <span className="text-primary">{año}</span></p>
                                <input type="range" className="w-full h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-primary" min={2010} max={2025} value={año} onChange={(e) => setAño(e.target.value)} />
                            </label>
                        </div>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="border-2 border-dashed border-darkBorder rounded-custom p-6 text-center hover:border-primary/50 transition-colors relative">
                                ...
                                <p className="text-sm text-slate-400">{logotipo ? "✅ Imagen Cargada" : "Haz clic para subir logo"}</p>
                    ...
                    <section className="bg-darkSurface/30 p-6 rounded-xl border border-darkBorder">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <label>
                                <p className="text-slate-300 text-sm mb-2">Descripción Completa</p>
                                <textarea className="form-input-custom !h-32" value={descripcion} onChange={(e) => setDescripcion(e.target.value)} placeholder="Detalla tu solución..." />
                            </label>
                        </div>
                    </section>
                    ...
                    <section className="bg-darkSurface/30 p-6 rounded-xl border border-darkBorder">
                        <div className="flex items-center gap-2 mb-6 border-b border-darkBorder pb-2">
                            ...
                            <h2 className="text-slate-100 text-xl font-bold">Métricas & Fundraising</h2>
                        </div>
                    ...
                    <div className="flex flex-col items-center gap-4 py-10">
                        ...
                        <p className="text-xs text-slate-500 text-center max-w-xs">
                            Al enviar, aceptas los términos de servicio para fundadores de StartupHub.
                        </p>
                    </div>
                </div>
            </main>
